...
cin >> FPerturbZ;
 ...
 cout <<"g(r)="<<G<<"*"<<M<<"/"<<r<<"^2=>"<<endl;
 cout <<result<<"m/s^2"<<endl; // 2 = ? added units when output
 } // New 1 = @ = $
